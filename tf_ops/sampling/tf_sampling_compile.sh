...
/usr/local/cuda-8.0/bin/nvcc $HOME/pointnet2/tf_ops/sampling/tf_sampling_g.cu -o $HOME/pointnet2/tf_ops/sampling/tf_sampling_g.cu.o -c -O2 -DGOOGLE_CUDA=1 -x cu -Xcompiler -fPIC
